...
**Status:** Accepted (Spec 35)

## Context

Spec 35 adds directional connector arrows between segment endpoints — the Chrome DevTools "Initiated
...
named follow-up (see Spec 35 "Out of scope"). Adding fields before a real consumer exists would
