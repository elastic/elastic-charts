...
**Status:** Accepted (Spec 28)

## Context

Spec 28 adds directional connector arrows between segment endpoints — the Chrome DevTools "Initiated
...
named follow-up (see Spec 28 "Out of scope"). Adding fields before a real consumer exists would
