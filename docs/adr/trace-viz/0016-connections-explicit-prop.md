...
**Status:** Accepted (Spec 31)

## Context

Spec 31 adds directional connector arrows between segment endpoints — the Chrome DevTools "Initiated
...
named follow-up (see Spec 31 "Out of scope"). Adding fields before a real consumer exists would
