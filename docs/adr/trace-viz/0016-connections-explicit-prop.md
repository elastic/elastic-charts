...
Spec 27 adds directional connector arrows between segment endpoints — the Chrome DevTools "Initiated
...
named follow-up (see Spec 27 "Out of scope"). Adding fields before a real consumer exists would
