...
**Status:** Accepted (Spec 33)

## Context

Spec 33 adds directional connector arrows between segment endpoints — the Chrome DevTools "Initiated
...
named follow-up (see Spec 33 "Out of scope"). Adding fields before a real consumer exists would
