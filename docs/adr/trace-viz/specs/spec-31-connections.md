...
- `storybook/stories/trace/33_connections.story.tsx` — new story; register in `trace.stories.tsx`.
...
6. Author `33_connections.story.tsx`; register in `trace.stories.tsx`.

## Storybook

`storybook/stories/trace/33_connections.story.tsx`:
