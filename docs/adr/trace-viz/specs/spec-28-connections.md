...
- `storybook/stories/trace/30_connections.story.tsx` — new story; register in `trace.stories.tsx`.
...
6. Author `30_connections.story.tsx`; register in `trace.stories.tsx`.

## Storybook

`storybook/stories/trace/30_connections.story.tsx`:
