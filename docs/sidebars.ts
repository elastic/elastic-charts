      ...
      items: [
        {
          ...
          label: 'Interfaces',
          items: [
            { type: 'autogenerated', dirName: 'all-types/interfaces' },
          ],
        },
        {
          type: 'category',
          label: 'Functions',
          items: [
            { type: 'autogenerated', dirName: 'all-types/functions' },
          ],
        },
        {
          type: 'category',
          label: 'Variables',
          items: [
            { type: 'autogenerated', dirName: 'all-types/variables' },
          ],
        },
        {
          type: 'category',
          label: 'Type Aliases',
          items: [
            { type: 'autogenerated', dirName: 'all-types/type-aliases' },
          ],
        },
      ],
