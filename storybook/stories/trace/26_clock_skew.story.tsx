...
Example.parameters = {
  markdown: [
    ...
    '**Malformed topology.** A missing-parent span stays an orphan root; a parent cycle and two malformed duplicate IDs are retained without hanging. This case is forced to chronological order because duplicate/cyclic tree relationships are unspecified by ADR 0027. Kibana-style orphan reparenting is deliberately outside Spec 24.',
