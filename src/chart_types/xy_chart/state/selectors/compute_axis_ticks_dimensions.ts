...
import { computeAxisTicksDimensions, isDuplicateAxis } from '../../utils/axis_utils';
...
export const computeAxisTicksDimensionsSelector = createCachedSelector(
  [getAxisSpecsSelector, getChartThemeSelector, getSettingsSpecSelector, computeSeriesDomainsSelector],
  (axesSpecs, chartTheme, settingsSpec, seriesDomainsAndData): Map<AxisId, AxisTicksDimensions> => {
