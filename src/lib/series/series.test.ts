...
describe('Series', () => {
  ...
  test('should only include deselectedDataSeries when splitting series if deselectedDataSeries is defined', () => {
    ...
    const deselectedDataSeries: DataSeriesValues[] = [
      {
        specId,
        colorValues: ['y1'],
      },
  ...
  test('should sort series color by series spec sort index', () => {
    ...
    const dataSeriesValues1: DataSeriesValues = {
      specId: spec1Id,
      colorValues: [],
      specSortIndex: 0,
    };

    const dataSeriesValues2: DataSeriesValues = {
      specId: spec2Id,
      colorValues: [],
      specSortIndex: 1,
    };

    const dataSeriesValues3: DataSeriesValues = {
      specId: spec3Id,
      colorValues: [],
      specSortIndex: 3,
    };
