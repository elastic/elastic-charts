...
describe('[Scale Time] - timezones', () => {
  ...
  describe('invert and ticks on different timezone', () => {
    test('shall invert local', () => {
      ...
      expect(scale.invertWithStep(25, data)).toBe(startTime);
      expect(scale.invertWithStep(50, data)).toBe(startTime);
      expect(scale.invertWithStep(74, data)).toBe(midTime);
      expect(scale.invertWithStep(76, data)).toBe(midTime);
      expect(scale.invertWithStep(100, data)).toBe(midTime);
    ...
    test('shall invert UTC', () => {
      ...
      expect(scale.invertWithStep(50, data)).toBe(startTime);
      expect(scale.invertWithStep(74, data)).toBe(midTime);
      expect(scale.invertWithStep(75, data)).toBe(midTime);
      expect(scale.invertWithStep(100, data)).toBe(midTime);
      expect(scale.tickValues.length).toBe(9);
      expect(scale.tickValues[0]).toEqual(startTime);
      expect(scale.tickValues[4]).toEqual(midTime);
