...
export class LegendComponent extends React.Component<LegendProps> {
  ...
  render() {
    ...
    const itemProps: Omit<LegendItemProps, 'item'> = {
      ...
      onLegendItemOutListener: this.props.onItemOut,
      onLegendItemOverListener: this.props.onItemOver,
      onLegendItemClickListener: this.props.onItemClick,
      ...
      legendItemOutAction: this.props.onItemOutAction,
      legendItemOverAction: this.props.onItemOverAction,
      ...
      <div className={legendClasses}>
        <div style={legendContainerStyle} className="echLegendListContainer">
          <ul style={legendListStyle} className="echLegendList">
            {items.map((item) => {
              return renderLegendItem(item, itemProps, items.length);
            })}
          </ul>
        </div>
      </div>
