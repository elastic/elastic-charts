...
test.describe('Metric', () => {
  ...
  test('should render metric body content when body overflows', async ({ page }) => {
    await common.expectChartAtUrlToMatchScreenshot(page)(
      'http://localhost:9001/?path=/story/metric-alpha--body-content',
      {
        maxDiffPixels: 5,
        action: async () => await common.setResizeDimensions(page)({ height: 100, width: 180 }),
      },
    );
  });
  ...
  test('should use restrictive breakpoint at 99px height', async ({ page }) => {
    await common.expectChartAtUrlToMatchScreenshot(page)(
      'http://localhost:9001/?path=/story/metric-alpha--layout&globals=toggles.showHeader:true;toggles.showChartTitle:false;toggles.showChartDescription:false;toggles.showChartBoundary:false;theme:light&knob-Aria description_Metric=This is a description&knob-Is numeric metric_Metric=true&knob-Title_Labels=Count of records Count of records Count of records Count of records&knob-Subtitle_Labels=Subtitle Subtitle Subtitle Subtitle Subtitle&knob-Value_Metric=5&knob-Show extra_Metric=true&knob-Label_Metric=Last week&knob-Color by value_Metric=true&knob-Secondary metric label position_Metric=before&knob-Secondary metric trend icon_Metric=↑&knob-Secondary metric trend icon position_Metric=after&knob-Secondary metric value_Metric=87.20&knob-Secondary metric value color_Metric=rgb(93, 191, 149)&knob-Visualization type_Progress bar=none&knob-Show metric icon_Labels=true&knob-Progress bar direction_Progress bar=horizontal',
      {
  ...
  test('should use restrictive breakpoint at 149px height', async ({ page }) => {
    await common.expectChartAtUrlToMatchScreenshot(page)(
      'http://localhost:9001/?path=/story/metric-alpha--layout&globals=toggles.showHeader:true;toggles.showChartTitle:false;toggles.showChartDescription:false;toggles.showChartBoundary:false;theme:light&knob-Aria description_Metric=This is a description&knob-Is numeric metric_Metric=true&knob-Title_Labels=Count of records Count of records Count of records Count of records&knob-Subtitle_Labels=Subtitle Subtitle Subtitle Subtitle Subtitle&knob-Value_Metric=5&knob-Show extra_Metric=true&knob-Label_Metric=Last week&knob-Color by value_Metric=true&knob-Secondary metric label position_Metric=before&knob-Secondary metric trend icon_Metric=↑&knob-Secondary metric trend icon position_Metric=after&knob-Secondary metric value_Metric=87.20&knob-Secondary metric value color_Metric=rgb(93, 191, 149)&knob-Visualization type_Progress bar=bar&knob-Show metric icon_Labels=true&knob-Progress bar direction_Progress bar=horizontal',
      {
  ...
  test.describe('Layout configuration', () => {
    ...
    test(`with default secondary and 'after' secondary label position`, async ({ page }) => {
      await common.expectChartAtUrlToMatchScreenshot(page)(
        'http://localhost:9001/?path=/story/metric-alpha--layout&globals=toggles.showHeader:true;toggles.showChartTitle:false;toggles.showChartDescription:false;toggles.showChartBoundary:false;theme:light&knob-Aria description_Metric=This is a description&knob-Is numeric metric_Metric=true&knob-Title_Labels=Count of records&knob-Subtitle_Labels=Little description of this component&knob-Value_Metric=55.23&knob-Show extra_Metric=true&knob-Label_Metric=Last week&knob-Color by value_Metric=true&knob-Secondary metric label position_Metric=after&knob-Secondary metric trend icon_Metric=↑&knob-Secondary metric trend icon position_Metric=after&knob-Secondary metric value_Metric=87.20&knob-Secondary metric value color_Metric=rgb(93, 191, 149)&knob-Visualization type_Progress bar=bar',
        {
          action: async () => await common.setResizeDimensions(page)({ height: 180, width: 180 }),
        },
      );
    ...
    test(`with value at the top, center aligned, and a metric icon`, async ({ page }) => {
      await common.expectChartAtUrlToMatchScreenshot(page)(
        'http://localhost:9001/?path=/story/metric-alpha--layout&globals=toggles.showHeader:true;toggles.showChartTitle:false;toggles.showChartDescription:false;toggles.showChartBoundary:false;theme:light&knob-Aria description_Metric=This is a description&knob-Is numeric metric_Metric=true&knob-Title_Labels=Count of records&knob-Subtitle_Labels=Little description of this component&knob-Value_Metric=55.23&knob-Show extra_Metric=true&knob-Label_Metric=Last week&knob-Color by value_Metric=true&knob-Secondary metric label position_Metric=before&knob-Secondary metric trend icon_Metric=↑&knob-Secondary metric trend icon position_Metric=after&knob-Secondary metric value_Metric=87.20&knob-Secondary metric value color_Metric=rgb(93, 191, 149)&knob-Visualization type_Progress bar=bar&knob-Show metric icon_Labels=true&knob-Primary metric alignment_Labels=center&knob-Title and subtitle alignment_Labels=center',
        {
          action: async () => await common.setResizeDimensions(page)({ height: 180, width: 180 }),
        },
      );
    ...
    test(`with titles at the top, center aligned, and a metric icon`, async ({ page }) => {
      await common.expectChartAtUrlToMatchScreenshot(page)(
        'http://localhost:9001/?path=/story/metric-alpha--layout&globals=toggles.showHeader:true;toggles.showChartTitle:false;toggles.showChartDescription:false;toggles.showChartBoundary:false;theme:light&knob-Aria description_Metric=This is a description&knob-Is numeric metric_Metric=true&knob-Title_Labels=Count of records&knob-Subtitle_Labels=Little description of this component&knob-Value_Metric=55.23&knob-Show extra_Metric=true&knob-Label_Metric=Last week&knob-Color by value_Metric=true&knob-Secondary metric label position_Metric=before&knob-Secondary metric trend icon_Metric=↑&knob-Secondary metric trend icon position_Metric=after&knob-Secondary metric value_Metric=87.20&knob-Secondary metric value color_Metric=rgb(93, 191, 149)&knob-Visualization type_Progress bar=bar&knob-Show metric icon_Labels=true&knob-Primary metric alignment_Labels=center&knob-Primary metric position_Labels=bottom&knob-Title and subtitle alignment_Labels=center',
        {
          action: async () => await common.setResizeDimensions(page)({ height: 180, width: 180 }),
        },
      );
