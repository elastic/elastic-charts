...
test.describe('Heatmap stories', () => {
  ...
  pwEach.test([[2], [3], [4], [5], [6], [7], [8], [9]])(
    ...
    async (page, dataset) => {
      ...
      await common.expectChartAtUrlToMatchScreenshot(page)(
        `http://localhost:9001/?path=/story/heatmap-alpha--time-snap&globals=theme:eui-light&knob-dataset=${dataset}`,
      );
    },
  );
  ...
  test('rotate categorical axis labels', async ({ page }) => {
    await common.expectChartAtUrlToMatchScreenshot(page)(
      'http://localhost:9001/?path=/story/heatmap-alpha--label-rotation&globals=theme:eui-light&knob-Y-axis auto width=true&knob-Y-axis width=50&knob-X-Axis visible=true&knob-X-Axis label fontSize=12&knob-X-Axis label padding=6&knob-X-Axis label rotation=45&knob-Use categorical data=true&knob-Show legend=',
    );
  });

  test('rotate time axis labels', async ({ page }) => {
    await common.expectChartAtUrlToMatchScreenshot(page)(
      'http://localhost:9001/?path=/story/heatmap-alpha--label-rotation&globals=theme:eui-light&knob-Y-axis auto width=true&knob-Y-axis width=50&knob-X-Axis visible=true&knob-X-Axis label fontSize=12&knob-X-Axis label padding=6&knob-X-Axis label rotation=45&knob-Use categorical data=&knob-Show legend=',
    );
  });

  test('render table with all nulls', async ({ page }) => {
    await common.expectChartAtUrlToMatchScreenshot(page)(
      'http://localhost:9001/?path=/story/heatmap-alpha--sorting&globals=theme:eui-light&knob-Fill gaps with nulls=true&knob-Fill everything with nulls=true&knob-X sorting predicate=dataIndex&knob-Y sorting predicate=dataIndex',
    );
  });
