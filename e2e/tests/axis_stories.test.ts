...
test.describe('Axis stories', () => {
  ...
  test('renders multilayer time axis with a single point and an arbitrary non-degenerate domain', async ({ page }) => {
    await common.expectChartAtUrlToMatchScreenshot(page)(
      'http://localhost:9001/?path=/story/bar-chart--test-single-histogram-bar-chart&globals=theme:eui-light&knob-non-round time domain start=true&knob-use multilayer time axis=true&knob-use lines instead of bars=true',
    );
  });
  test('renders multilayer time axis with a single point and a degenerate, zero width domain', async ({ page }) => {
    await common.expectChartAtUrlToMatchScreenshot(page)(
      'http://localhost:9001/?path=/story/bar-chart--test-single-histogram-bar-chart&globals=theme:eui-light&knob-non-round time domain start=&knob-use multilayer time axis=true&knob-use lines instead of bars=true',
    );
  });
