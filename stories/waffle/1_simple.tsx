...
import { Chart, Datum, Partition, PartitionLayout, Settings, ShapeTreeNode } from '../../packages/charts/src';
...
export const Example = () => {
  ...
  return (
    <Chart className="story-chart">
      <Settings theme={STORYBOOK_LIGHT_THEME} debug={showDebug} showLegend flatLegend showLegendExtra />
      <Partition
        id="spec_1"
