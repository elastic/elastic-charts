...
import { Chart, Datum, Partition, PartitionLayout, PrimitiveValue, Settings } from '../../packages/elastic-charts/src';
import data from '../../packages/elastic-charts/src/mocks/hierarchical/cpu_profile_tree_mock.json';
