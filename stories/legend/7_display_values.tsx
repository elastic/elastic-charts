...
import { AreaSeries, Axis, Chart, CurveType, Position, ScaleType, Settings } from '../../packages/elastic-charts/src';
import { TSVB_DATASET } from '../../packages/elastic-charts/src/utils/data_samples/test_dataset_tsvb';
