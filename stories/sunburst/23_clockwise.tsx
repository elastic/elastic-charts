...
import { Chart, Datum, Partition, PartitionLayout, Settings, LIGHT_THEME } from '../../packages/elastic-charts/src';
...
export const Example = () => (
  <Chart className="story-chart">
    <Settings theme={STORYBOOK_LIGHT_THEME} baseTheme={LIGHT_THEME} />
    <Partition
      id="spec_1"
      data={mocks.pie}
