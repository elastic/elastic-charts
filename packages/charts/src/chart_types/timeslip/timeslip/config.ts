...
import type { LocaleOptions } from './render/annotations/time_extent';
...
import type { RasterConfig, TimeFormatter } from '../../xy_chart/axes/timeslip/continuous_time_rasters';
