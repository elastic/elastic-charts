  ...
  describe('getAvailableTicks', () => {
    ...
    test('should extend ticks to domain + minInterval in histogram mode for time scale', () => {
      ...
      const expectedTickValues = [
        1560438420000, 1560438435000, 1560438450000, 1560438465000, 1560438480000, 1560438495000, 1560438510000,
        1560438525000, 1560438540000, 1560438555000, 1560438570000, 1560438585000, 1560438600000,
      ];
