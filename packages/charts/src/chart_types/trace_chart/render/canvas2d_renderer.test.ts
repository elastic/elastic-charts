...
const spans: NormalizedSpan[] = [
  {
    ...
    meta: { id: 'a', name: 'SpanA', traceId: 't1', start: 0, end: 1000 } as TraceDatum,
  },
  {
    id: 'b',
    name: 'SpanB',
    ...
    meta: { id: 'b', name: 'SpanB', traceId: 't1', start: 100, end: 900 } as TraceDatum,
  },
  {
    id: 'c',
    name: 'SpanC',
    ...
    active: [],
    meta: { id: 'c', name: 'SpanC', traceId: 't1', start: 200, end: 700 } as TraceDatum,
  },
];
    ...
    const spansWithOob: NormalizedSpan[] = [
      {
        ...
        meta: { id: 'x', name: 'OOB', traceId: 't1', start: 0, end: 1000 } as TraceDatum,
      },
    ];
    ...
    const coloredSpans: NormalizedSpan[] = [
      {
        ...
        active: [{ start: 0, end: 500 }],
        color: '#ff0000',
        meta: { id: 'col', name: 'Colored', traceId: 't1', start: 0, end: 500 } as TraceDatum,
      },
    ];
