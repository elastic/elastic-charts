...
const mouseTransformState = select(getMouseTransformState)(mouseTransformGesturePrev, dragging, dragVector);
...
const transformIntents = select((directIntents, commandIntents) => directIntents.concat(commandIntents))(
  directManipulationTransformIntents,
  commandTransformIntents,
);
...
const constrainedShapesWithPreexistingAnnotations = select(getConstrainedShapesWithPreexistingAnnotations)(
  snappedShapes,
  transformedShapes,
);
...
const groupedSelectedPrimaryShapeIds = select(getGroupedSelectedPrimaryShapeIds)(groupedSelectedShapes);
