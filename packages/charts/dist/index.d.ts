...
export { AnimationOptions, AnimatedValue, AnimationSpeed, } from './chart_types/xy_chart/renderer/canvas/animations/animation';
...
export { ColorBand, HeatmapBandsColorScale, HeatmapProps, HeatmapHighlightedData, } from './chart_types/heatmap/specs/heatmap';
export { Datum, Position, Rendering, Rotation, VerticalAlignment, HorizontalAlignment, RecursivePartial, NonAny, IsAny, IsUnknown, ColorVariant, LabelAccessor, ShowAccessor, ValueAccessor, ValueFormatter, LayoutDirection, } from './utils/common';
