...
/** @public */
export declare type TickStyle = StrokeStyle & Visible & {
    /**
...
/** @public */
export declare type DisplayValueStyle = Omit<TextStyle, 'fill' | 'fontSize'> & {
    offsetX: number;
    offsetY: number;
    fontSize: number | {
        min: number;
...
/** @public */
export declare const PointShape: Readonly<{
    Circle: "circle";
    Square: "square";
    Diamond: "diamond";
    Plus: "plus";
...
/** @public */
export declare type PointShape = $Values<typeof PointShape>;
/** @public */
...
/** @public */
export declare const TextureShape: Readonly<{
    Line: "line";
    Circle: "circle";
    Square: "square";
    Diamond: "diamond";
...
/** @public */
export declare type TextureShape = $Values<typeof TextureShape>;
/** @public */
 ...
 */
export declare type TexturedStyles = TexturedPathStyles | TexturedShapeStyles;
/** @public */
...
/** @public */
export declare type AreaFitStyle = Visible & Opacity & {
    fill: Color | typeof ColorVariant.Series;
    texture?: TexturedStyles;
};
/** @public */
export declare type LineFitStyle = Visible & Opacity & StrokeDashArray & {
...
/** @public */
export declare type RectAnnotationStyle = StrokeStyle & FillStyle & Opacity & Partial<StrokeDashArray>;
