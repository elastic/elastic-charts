...
/** @public */
export declare type LayoutDirection = $Values<typeof LayoutDirection>;
/**
...
/** @public */
export declare type ColorVariant = $Values<typeof ColorVariant>;
/** @public */
 ...
 * @public
 */
export declare type HorizontalAlignment = $Values<typeof HorizontalAlignment>;
/** @public */
 ...
 * @public
 */
export declare type VerticalAlignment = $Values<typeof VerticalAlignment>;
/** @public */
...
/** @public */
export declare type StrokeStyle = Color;
/**
...
/** @public */
export declare type NonAny = number | boolean | string | symbol | null;
/** @public */
...
/** @public */
export declare type ValueAccessor<D extends BaseDatum = Datum> = (d: D) => AdditiveNumber;
/** @public */
export declare type LabelAccessor<T = PrimitiveValue> = (value: T) => string;
/** @public */
export declare type ShowAccessor = (value: PrimitiveValue) => boolean;
/**
