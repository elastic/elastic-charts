...
var timeslip_chart_1 = require("./timeslip_chart");
var TimeslipState = (function () {
    function TimeslipState() {
        this.chartType = __1.ChartType.Timeslip;
        this.getChartTypeDescription = function () { return 'Timeslip chart'; };
