...
var CursorBandComponent = (function (_super) {
    ...
    CursorBandComponent.prototype.render = function () {
        var _a, _b;
        var _c = this.props, bandStyle = _c.bandStyle, cursorPosition = _c.cursorPosition, tooltipType = _c.tooltipType, fromExternalEvent = _c.fromExternalEvent;
        ...
        var fill = bandStyle.fill;
        return (react_1.default.createElement("svg", { className: "echCrosshair__cursor", width: "100%", height: "100%" },
            react_1.default.createElement("rect", __assign({}, { x: x, y: y, width: width, height: height, fill: fill, opacity: 0.5 }))));
    };
